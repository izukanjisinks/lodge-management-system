...
func RegisterBookingRoutes(h *handlers.BookingHandler) {
	...
	http.HandleFunc("POST /api/v1/bookings",
		withAuthAndRole(h.Create, models.RoleAdmin, models.RoleBranchAdmin, models.RoleManager, models.RoleReceptionist))

	http.HandleFunc("PUT /api/v1/bookings/{id}",
		withAuthAndRole(h.Update, models.RoleAdmin, models.RoleBranchAdmin, models.RoleManager, models.RoleReceptionist))
	...
	http.HandleFunc("PATCH /api/v1/bookings/{id}/clear-overstayed",
		withAuthAndRole(h.ClearOverstayed, models.RoleAdmin, models.RoleBranchAdmin, models.RoleManager, models.RoleReceptionist))

	// Delete — admin and manager only
	http.HandleFunc("DELETE /api/v1/bookings/{id}",
		withAuthAndRole(h.Delete, models.RoleAdmin, models.RoleBranchAdmin, models.RoleManager, models.RoleReceptionist))
}
